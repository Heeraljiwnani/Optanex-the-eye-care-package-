...
##  Features
## AI-powered prescreening: OptiScreen
* A comprehensive at-home preliminary  eye screening tool that provides preliminary assessment


##  Precreening of the following eye conditions:
...
* **OptiTracker** – Track vision power (spherical, cylindrical, axis)



* **PrescriptTracker** – Store & share prescriptions



* **GlareGaurd** – Monitor device screen time & get recommendations



* **EyeChronicle** – Securely store past diagnostics and treatments
